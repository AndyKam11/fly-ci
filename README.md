...
- Rot scores combine the simulated response with caps for text length, vocabulary variety and the number of bait patterns. A short trigger phrase cannot earn 90–100%; sense coverage adds ceilings of 65%, 79%, 89%, 95% and 100% for one through five activated senses. All five are necessary but not sufficient for 100%.
